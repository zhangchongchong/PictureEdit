...
//
        ...
        NSLog(@"scale  = %f",scale);
//        _editImgView.transform = CGAffineTransformScale(_editImgView.transform, scale, scale);
//        _closeImgView.transform = CGAffineTransformScale(_closeImgView.transform,scale, scale);
